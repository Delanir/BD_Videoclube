...
public class Utils
{
	...
	/* ------------------------------------------------------------------------------------- */
	/* ---------------------------- M�TODOS DE VECTORS E ARRAYS ---------------------------- */
	/* ------------------------------------------------------------------------------------- */

	/* ---------------------------- UTILS ---------------------------- */
	/**
	 * Une o conte�do de dois arrays de Strings num s�.
	 */
	...
	/**
	 * Obt�m um array de Strings com os elementos do array original a partir do �ndice "from". 
	 */
	 ...
	 * com os antigos arrays em sequ�ncia.
	 */
	...
	/**
	 * Converte um Vector de arrays de Strings para um array apenas,
	 * usando somente o elemento de �ndice "index" de cada array.
	 */
	...
	/**
	 * Gera um array de Strings, em que cada String s�o os elementos de �ndice "indexes"
	...
	/**
	 * Imprime um array de Strings numa linha, com os elementos separados por v�rgulas.
	 */
	 ...
	 * @param strnumber o n�mero (em formato String) a converter.
	 * @return a o n�mero convertido ou ERROR_DOUBLE (definido em Consts) se a convers�o � imposs�vel.
	 */
