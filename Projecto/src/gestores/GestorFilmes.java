...
public class GestorFilmes
{
	 ...
	 */
	// TODO: assumi que "String[] generos" contÈm IDs e n„o nomes de gÈneros.
	// tambÈm assumi que o ano e ratingIMDB vÍm correctos, embora ainda tenha a verificaÁ„o
	// TODO: adicionar generos (difÌcil. tenho de saber o ID do filme k acabei de adicionar)
	...
	/* --------------------------------------------------------------------------------- */
	/**
	 * @param idMovie identificador un√≠voco do filme na base de dados
	 * @param formato bluray, dvd,etc..
	 * @param custo quanto √© que o filme custou ao videoclube
	 * @param custoAluger pre√ßo praticado no aluguer
	 * @return
	 */
	// TODO: do it
	 ...
	 * @param idMovie identificador un√≠voco do filme na base de dados
	 * @param formato bluray, dvd,etc..
	 * @param quantidade n√∫mero de c√≥pias a eliminar
	 * @return
	 */
	// TODO: do it
	...
	/**
	 * Cada par√¢metro pode ser null se n√£o for para ser utilizado na mega
	 * query
	 * @param titulo
	 * @param ano
	 * @param imdbBegin
